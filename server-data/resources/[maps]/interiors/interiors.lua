...
Citizen.CreateThread(function()
	...
	ActivateInteriorEntitySets(37122, "Valentine hotel", {
		"MUD3_val_hotel_room1b_curtain",
		"MUD3_val_hotel_room1b_prayercurtain",
		"mud3_val_hotel_room_curtain01",
		"LevDes_Val_MUD3"
	})

	ActivateInteriorEntitySets(1026, "Valentine Doctor", {
...
--[[ 	ActivateInteriorEntitySets(60674, "Docked Riverboat", {
		"korrigan_props_poker"
	}) ]]
	...
	ActivateInteriorEntitySets(72706, "Braithwaite mansion", {
		...
		-- "bra_mansion_dining_groups", --dining table setup
		-- "bra_mansion_dining_csprops", --dining table setup
	})
...
--[[  	ActivateInteriorEntitySets(14338, "Aberdeen pig farm", {
	...
	ActivateInteriorEntitySets(45314, "Emerald Ranch saloon", {
		"eme_saloon_intgroup_furniture_mp"
	})
...
--[[ 	ActivateInteriorEntitySets(28418, "Carmody Dell", {
	...
	ActivateInteriorEntitySets(26626, "Galarie", {
		...
		-- "new_art_photos_post_RC_Mason",
		-- "new_art_exhibit_RC_Art3",
		-- "new_art_exhibit_post_RC_Art3"
		-- "new_forMyArt_paintings",
		"new_forMyArt_gallery",
		-- "st_denis_art_int_open",
	})
...
--[[  	ActivateInteriorEntitySets(67074, "Van Horn Mansion Monster", {
		"van_farmhouse_monster"
	}) ]]

	ActivateInteriorEntitySets(23042, "Arma Sheriff", {
		"arm_sheriff_int_normal_mp"
	})

	ActivateInteriorEntitySets(9730, "Lakay hideout", {
		"lak_hideout_intgroup_trapdoor"
	})

	ActivateInteriorEntitySets(28162, "Adler Ranch", {
		"adl_winter01_trapdoorclosed",
		"l_002b5d74mp"
	})

	ActivateInteriorEntitySets(64002, "Wildman's Cave", {
		"j_14_cave_wildman",
		"l_005c0d63ve"
	})

--[[ 	ActivateInteriorEntitySets(58882, "Van Horn Fence", {
		"_p_cigarettebox01x_dressing",
		"_p_cigarettebox01x_group",
		"_p_package01x_dressing",
		"_p_package01x_group",
...
RequestImap(637627640) -- Crate on porch
...
----------------------- Guthrie Farm House interior 1119 481.74 96 
...
----------------------- Tall Trees writers cabin -2376.0, -1590.96, 156.0
...
-- RequestImap(-643541706) -- Blackwater new build
-- RequestImap(-501793326) -- Blackwater new build
...
-- RequestImap(-1501864740)
 RequestImap(-1070814495) -- Vinnie's tent
...
-- RequestImap(2123794495)
 RequestImap(-248246131) --Titty tent
...
RequestImap(-755250900) -- Crashed Circus Wagon 1
RequestImap(1357785776) -- Crashed Circus Wagon 2
...
-- RequestImap(26544760) -- Lake Isabella camp (broken down)
...
RequestImap(-1652999737) -- Heartlands Farm House Interior
RequestImap(382484708) -- Heartlands Farm House Extras
...
-- RequestImap(-1665620584) -- Annesburg partially finished interior
...
-- RequestImap(-1595003151) -- invisible object next to rail line
...
------------- Appleseed Timber site -------------
 RequestImap(1749008611)
 RequestImap(2111695903) -- tents
 RequestImap(-1947695052) -- tents
-- RequestImap(-1559513478) -- debris
-- RequestImap(-1321905459)
-- RequestImap(-1560816708)
 --RequestImap(823583740) -- camp under construction
 RequestImap(-826466486) -- camp accessories
 RequestImap(-593183975) -- camp accessories
-- RequestImap(-362883443)  -- camp under construction
 RequestImap(-164693058) -- camp cooking pot
 RequestImap(-1385360243) -- camp cooking pot
 RequestImap(458453080) -- camp cooking pot
 RequestImap(-630275010) -- camp cooking pot
 RequestImap(-1288790000) -- camp cooking pot
 RequestImap(118201723) -- camp cooking pot
-- RequestImap(758066107) -- foreman under construction
-- RequestImap(-1995054197) -- foreman office used
 RequestImap(-1623126047) --foreman office complete
-- RequestImap(1943484686) -- foreman office rundown
-- RequestImap(2056603274) -- foreman office rundown
 RequestImap(898257133) -- foreman office roof
 -- RequestImap(-380287375) -- tidy station variant
 RequestImap(281153830) -- tidy station 
 --RequestImap(-2142583869)
 RequestImap(1739101350) -- debris
 --RequestImap(-634291786) -- broken down station
-- RequestImap(-1047158045) --log pile
 --RequestImap(42081460) -- half built animal pen frame
 RequestImap(870580095) -- more animal pen parts
 RequestImap(504746979) -- full animal; pen
 RequestImap(-981873755) -- grass
-- RequestImap(138913863) --broken down animal pen
-- RequestImap(-90108678) --broken down animal pens 
-- RequestImap(1258244391)
RequestImap(1815262278) -- trees
RequestImap(1511919645) -- trees
-- RequestImap(767505137) -- tree stumps (around camp)
-- RequestImap(588062093) -- tree stumps
RequestImap(471934509) -- grass
-- RequestImap(995675696) -- tree stumps
-- RequestImap(706423733) -- tree stumps
-- RequestImap(-125588314) -- trees (some overlap tents)
RequestImap(-1340001373) -- trees
RequestImap(-2116397290) -- trees
RequestImap(-922917541) -- trees
RequestImap(1524580507) -- trees
RequestImap(204481342) -- trees
-- RequestImap(-1466172032) -- tree stumps
-- RequestImap(2013143748) -- grass
-- RequestImap(82084523) -- sticks on ground
-- RequestImap(1289178060) -- saplings around camp
...
--[[ -- RequestImap(-927211837)  -- Horseshoe Overlook  -- Arthur's Tent -- Wagon cargo (bow & arrow)
-- RequestImap(-710911638) -- Horseshoe Overlook  -- Arthur's Tent -- Wagon cargo
-- RequestImap(-942555699) -- Horseshoe Overlook  -- Arthur's Tent -- Wagon cargo
-- RequestImap(-760097927) -- Horseshoe Overlook  -- Arthur's Tent -- Wagon cargo
-- RequestImap(607574432) -- Horseshoe Overlook  -- Arthur's Tent -- Wagon&Lean-To (v3)
RequestImap(-1563072795) -- Horseshoe Overlook  -- Arthur's Tent -- Wagon&Lean-To (v1)
-- RequestImap(825179479) -- Horseshoe Overlook  -- Arthur's Tent -- Wagon&Lean-To (v2)
-- RequestImap(-293283707) -- Horseshoe Overlook  -- Arthur's Tent --  Book
-- RequestImap(-539928451) -- Horseshoe Overlook  -- Arthur's Tent --  Book
-- RequestImap(1526869387) -- Horseshoe Overlook  -- Arthur's Tent --  Wagon cargo + debris
-- RequestImap(213881095) -- Horseshoe Overlook  -- Arthur's Tent -- Wagon cargo + debris
-- RequestImap(2122708114) -- Horseshoe Overlook  -- Arthur's Tent -- Wagon cargo
-- RequestImap(-1031045988) -- Horseshoe Overlook -- Arthur's Tent -- Single box
-- RequestImap(1108342912) -- Horseshoe Overlook -- Arthur's Tent -- Wagon cargo
-- RequestImap(976283842) -- Horseshoe Overlook -- Arthur's Tent -- Little boxes
-- RequestImap(736578607) -- Horseshoe Overlook  -- Arthur's Tent -- Mixed size boxes
-- RequestImap(1707393029) -- Horseshoe Overlook  -- Arthur's Tent -- Little boxes
-- RequestImap(478657470) -- Horseshoe Overlook  -- Arthur's Tent -- Little boxes
-- RequestImap(-355608501) -- Horseshoe Overlook  -- Arthur's Tent -- Little boxes
-- RequestImap(957052101) -- Horseshoe Overlook  -- Arthur's Tent -- Mixed size boxes
-- RequestImap(123244896) -- Horseshoe Overlook  -- Arthur's Tent -- Mixed size boxes
RequestImap(173790065)
RequestImap(607173790) -- Horseshoe Overlook -- Arthur's Tent -- Shaving kit
-- RequestImap(-520400509) -- Horseshoe Overlook -- Girls Wagon -- Guarma Rum Barrel
RequestImap(-1920340119) -- Horseshoe Overlook -- Awning 
-- RequestImap(-1576393943) -- Horseshoe Overlook -- Awning (dirty w/ debris)
-- RequestImap(-413795019) -- Horseshoe Overlook -- Awning 
-- RequestImap(-1559012672) -- Horseshoe Overlook -- Awning (dirty?)
RequestImap(288413571) -- Horseshoe Overlook -- Dutch's Tent -- Cloth over barrel variant
-- RequestImap(1103365569)
-- RequestImap(-2037661155) -- Horseshoe Overlook -- Dutch's Tent -- Cloth over barrel
-- RequestImap(-1150137955) -- Horseshoe Overlook -- Chicken coop
RequestImap(-1954657946) -- Horseshoe Overlook -- Table with fishing supplies
-- RequestImap(207396248)
RequestImap(-110381721)  -- Horseshoe Overlook -- Fishing Creel
RequestImap(1366418802) -- Horseshoe Overlook -- Marstons Tent -- Lockbox
RequestImap(-2125611324) -- Horseshoe Overlook -- Hitching posts
-- RequestImap(1453569688) -- Horseshoe Overlook -- tucked in folding stool
-- RequestImap(-80564929) -- Horseshoe Overlook -- Girls wagons -- Hay bales + debris
RequestImap(1157066259) -- Horseshoe Overlook -- Dutch's Tent -- Tent (Clean)
-- RequestImap(1720188956) -- Horseshoe Overlook -- Dutch's Tent -- Tent (Brand new)
-- RequestImap(1475953931) -- Horseshoe Overlook -- Dutch's Tent -- Tent (Clean, doors open)
RequestImap(-1166561064) -- Horseshoe Overlook -- Dutch's Tent -- Tent Interior 1
-- RequestImap(-1365193577) -- Horseshoe Overlook -- Dutch's Tent -- Crates Interior
-- RequestImap(300868838) -- Horseshoe Overlook -- Dutch's Tent -- Tent (Dirty, doors closed)
-- RequestImap(-316909020) -- Horseshoe Overlook -- Dutch's Tent -- Tent (Dirty, doors open)
-- RequestImap(172011504) -- Horseshoe Overlook -- Dutch's Tent -- Tent Interior 2
-- RequestImap(-1788578071) -- Horseshoe Overlook -- Dutch's Tent -- Tent 
-- RequestImap(-1962893335) -- Horseshoe Overlook -- Dutch's Tent -- Tent 
-- RequestImap(1351589798) -- Horseshoe Overlook -- Dutch's Tent -- Tent 
-- RequestImap(1457661960) -- Horseshoe Overlook -- Dutch's Tent -- Tent (Clean, half open)
RequestImap(163126540) -- Horseshoe Overlook -- Marstons Tent -- Tent + interior
-- RequestImap(-1620486708) -- Horseshoe Overlook -- Marstons Tent -- Tent
-- RequestImap(-223906810) -- Horseshoe Overlook -- Marstons Tent -- Tent
RequestImap(2015311123) -- Horseshoe Overlook -- Girls wagons (clean)
-- RequestImap(1808508475) -- Horseshoe Overlook -- Girls wagons (dirty)
-- RequestImap(-379409079) -- Horseshoe Overlook -- Girls wagons (empty)
RequestImap(-102951407) -- Horseshoe Overlook -- lantern on pole
RequestImap(1998041523) -- Horseshoe Overlook -- lantern at fishing supplies
-- RequestImap(-1114426126) -- Horseshoe Overlook -- Marstons Tent -- Green Tent (Closed, buttoned up)
-- RequestImap(-1971474291) -- Horseshoe Overlook -- Marstons Tent -- Green Tent (Closed, buttoned up)
-- RequestImap(-1687561002) -- Horseshoe Overlook -- Marstons Tent -- Green Tent (Half open)
-- RequestImap(-1425946870) -- Horseshoe Overlook -- Marstons Tent -- Green Tent (Closed, buttoned up)
-- RequestImap(1957225320) -- Horseshoe Overlook -- Marstons Tent -- Green Tent (Half open)
-- RequestImap(-860696938) -- Horseshoe Overlook -- Marstons Tent -- Green Tent (Half open)
-- RequestImap(-1893724593) -- Horseshoe Overlook -- Arthur's Tent -- Mary picture
RequestImap(394987827) -- Horseshoe Overlook -- back tent
-- RequestImap(-937893311) -- Horseshoe Overlook -- back tent debris
-- RequestImap(321670654) -- Horseshoe Overlook -- back tent (dirty)
-- RequestImap(-1916602073) -- Horseshoe Overlook -- Centre table -- seating option
RequestImap(-1611076340) -- Horseshoe Overlook -- Lighting on Susan's wagon?
-- RequestImap(1079303588)
RequestImap(970924250) -- Horseshoe Overlook -- Boxes around musician fire
-- RequestImap(1381006186) -- Horseshoe Overlook -- centre tent (dirty)
RequestImap(-441619793) -- Horseshoe Overlook -- chuck wagon -- washing up tub/plates
-- RequestImap(140744122) -- Horseshoe Overlook -- chuck wagon -- broken kerosene barrel under
-- RequestImap(-1177590512) -- Horseshoe Overlook -- covered chuck wagon
RequestImap(1267297807) -- Horseshoe Overlook -- full chuck wagon
-- RequestImap(-182995231) -- Horseshoe Overlook -- chuck wagon
-- RequestImap(-1426249148) -- Horseshoe Overlook  -- chuck wagon -- depleted chuck wagon
RequestImap(-441619793) -- Horseshoe Overlook  -- chuck wagon -- boxes/tub
RequestImap(-1445186253) -- Horseshoe Overlook -- chuck wagon -- grain bags
RequestImap(2047954825) -- Horseshoe Overlook --
RequestImap(-2085723453) -- Horseshoe Overlook -- chuck wagon -- milk
RequestImap(1434945142) -- Horseshoe Overlook -- chuck wagon -- flannel cloths
RequestImap(658099812) -- Horseshoe Overlook -- 
RequestImap(360721137) -- Horseshoe Overlook -- 
RequestImap(1268291329) -- Horseshoe Overlook -- 
 RequestImap(943845492) -- Horseshoe Overlook -- 
-- RequestImap(-2037324418)
RequestImap(937052178) -- Horseshoe Overlook -- 
-- RequestImap(698067861) -- Horseshoe Overlook -- 
-- RequestImap(-741769242)
RequestImap(2019747962) -- Horseshoe Overlook -- 
RequestImap(1785810071) -- Horseshoe Overlook -- 
RequestImap(1423450469) -- Horseshoe Overlook -- 
RequestImap(1189709192) -- Horseshoe Overlook -- 
RequestImap(512556003) -- Horseshoe Overlook -- 
RequestImap(1770786479) -- Horseshoe Overlook -- 
-- RequestImap(2306984499) -- Horseshoe Overlook -- Susan's wagon v2
RequestImap(2361072059) -- Horseshoe Overlook -- Susan's wagon v1
-- RequestImap(4190830124) -- Horseshoe Overlook -- Susan's wagon v3
-- RequestImap(2022451711)
-- RequestImap(-1933895237)
-- RequestImap(-1987982797)
-- RequestImap(-104137172)
RequestImap(1924209179) -- Horseshoe Overlook -- 
-- RequestImap(-2084193212)
-- RequestImap(-838184752)
-- RequestImap(-1433138716)
-- RequestImap(-1103841944)
-- RequestImap(-621941030)
RequestImap(1782877577) -- Horseshoe Overlook -- 
-- RequestImap(-584027313)
RequestImap(1219098211) -- Horseshoe Overlook -- 
RequestImap(2097700639) -- Horseshoe Overlook -- 
RequestImap(728120284) -- Horseshoe Overlook -- 
RequestImap(1370097763) -- Horseshoe Overlook -- 
RequestImap(1948051928) -- Horseshoe Overlook - folding stools
-- RequestImap(1548546221)
RequestImap(106249677) -- Horseshoe Overlook --
-- RequestImap(1546110128)  -- Horseshoe Overlook -- Arthur's tent -- trunk v1
RequestImap(-855912354) -- Horseshoe Overlook -- Arthur's tent -- trunk v2
-- RequestImap(324486076) -- Horseshoe Overlook -- Arthur's tent -- hide rug 
-- RequestImap(-2052582076) -- Horseshoe Overlook -- Arthur's tent -- nice side table
RequestImap(-402976431) -- Horseshoe Overlook -- Arthur's tent -- basic side table 
...
-- RequestImap(-2077690059) -- Horseshoe Overlook -- chuck wagon -- hanging skull
-- RequestImap(1029525997) -- Horseshoe Overlook -- Arthur? wagon -- hanging skull
-- RequestImap(-15722296)
-- RequestImap(327932996)
RequestImap(-745860880) -- Horseshoe Overlook -- Centre table -- tabletop
RequestImap(1219276914) -- Horseshoe Overlook --  ]]
-------------------------------------
...
-- RequestImap(1734859244)
 RequestImap(-750963311) --Compson Stead Barn Interior (complete)
-- RequestImap(-886310806) --Compson Stead Barn Interior (burned down)
 RequestImap(1926336063) --Compson Stead Barn Interior (complete)
 RequestImap(-1552695732) --Compson Stead Barn Interior (complete)
...
RemoveImap(739805687) -- Oil rig at Wapiti
...
-- RequestImap(-1993960878) -- Tyranny of Taxation
...
-- RequestImap(1405627586) -- Mayor's Mansion Gates
...
-- RequestImap(1679182807)
 ...
 RemoveImap(146172383) --Gangplank to docked Grand Korrigan
 RemoveImap(291732199) --secondary gangplank
...
--[[ RequestImap(-1792518688) -- SD Boat ]]
...
-- RequestImap(-1795618779) -- Horseshoe Overlook grass patch
-- RequestImap(-1873685184) -- Horseshoe Overlook grass patch
-- RequestImap(-697307430) -- Horseshoe Overlook grass patch
RequestImap(633503129) -- Horseshoe Overlook grass
-- RequestImap(-1536198599) -- Horseshoe Overlook flattened grass
...
-- RequestImap(226557169)
 RequestImap(476687617) -- Lake Isabella Camp
...
RequestImap(-205029045) -- Annesburg interiors
RequestImap(1713454259) -- Annesburg interiors
RequestImap(4196124003) -- Lakay Dockhouse wall
RequestImap(2899255272) -- Lakay Dockhouse boxes
RemoveImap(-643541706) -- Blackwater new build
RemoveImap(-501793326) -- Blackwater new build
