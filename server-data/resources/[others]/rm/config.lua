        ...
        data = {
            ...
            wheels = {
                ...
                },
                {
                    ...
                    minRadiusPercent = 0.55,
                    maxRadiusPercent = 0.9,
                    labels = {"Surrender", "Hostage", "Hands up", "Caught", "Cover", "Scared", "Full", "Search", "Point", "Freezing cold", "Over Here"},
                    commands = {"overgiv", "Gidsel", "hænderop", "fanget", "dækning", "vige", "fuld", "søge", "pege", "hidkald", "fagter"}
                }
            }
        }
    },
