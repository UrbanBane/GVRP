local keys = { ['L'] = 0x80F28E95, ['S'] = 0xD27782E3, ['W'] = 0x8FD015D8, ['H'] = 0x24978A28, ['G'] = 0x5415BE48, ["ENTER"] = 0xC7B5340A, ['E'] = 0xDFF812F9 }
-- ["L"] = 0x80F28E95
-- ['F'] = 0xB2F377E8
local pressTime = 0
local pressLeft = 0
...
function GetCurrentTownName()
    ...
    elseif town_hash == GetHashKey("StDenis") then
        return "Saint Denis"
	elseif town_hash == 1778899666 then
		return "Braithwaite"
	else
