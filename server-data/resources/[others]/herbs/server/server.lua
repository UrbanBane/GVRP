...
local Items = {
	...
	{item = "consumable_herb_oregano", name = "some Oregano", amountToGive = math.random(1,2)},
    {item = "consumable_herb_vanilla_flower", name = "some Vanilla Flower", amountToGive = math.random(1,2)},
	...
	{item = "potato", name = "a Potato", amountToGive = math.random(1,3)},
	{item = "carrots", name = "a Carrot", amountToGive = math.random(1,3)},
	{item = "blueberry", name = "a Blueberry", amountToGive = math.random(1,3)},
	{item = "tobacco", name = "some Tobacco", amountToGive = math.random(1,2)},
	{item = "dandyflwr", name = "a Dandy flower", amountToGive = math.random(1,2)},
	{item = "lupinflwr", name = "a Lupin flower", amountToGive = math.random(1,2)},
	{item = "milkweedflwr", name = "a Milkweed flower", amountToGive = math.random(1,2)},
	{item = "poppyflwr", name = "a Poppy flower", amountToGive = math.random(1,2)},
