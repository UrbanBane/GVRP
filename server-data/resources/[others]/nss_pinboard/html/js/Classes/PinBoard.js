...
class PinBoard {
    ...
    _onNewBtnClick() {
        ...
        answer
            .then(() => {
                new NewPosterTextDialog(this, this._client, this._char_details.permissions.post_everywhere_at_once);
            })
            .catch(() => {
                new NewPosterImageDialog(this, this._client, this._char_details.permissions.post_everywhere_at_once);
            });
    }
