...
class NewPosterImageDialog {
     ...
     */
    constructor(pinboard, client, post_everywhere_at_once) {
    ...
    _onCheckBtnClick() {
        ...
        const regex = new RegExp('^(http|https):\\/\\/.*[.]{1}(jpg|png|jepg|webm)$', 'gmi')

        if (false === regex.test(image_url)) {
