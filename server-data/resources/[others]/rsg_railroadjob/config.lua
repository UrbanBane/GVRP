...
Config.Stops = {
	...
	-- EXAMPLE { dst = 180.0, dst2 = 4.0, x = -142.67, y = 654.18, z = 113.52, time = 60000, name = "Valentine Station" }, time is milliseconds of stop
	{ dst = 180.0, dst2 = 4.0, x = -142.67, y = 654.18, z = 113.52, time = 120000, name = "Valentine Station" }, --2 min stop
	{ dst = 400.0, dst2 = 4.0, x = 2685.39, y = -1480.33, z = 45.80, time = 300000, name = "Saint Denis Station" }, --5 min stop
	{ dst = 220.0, dst2 = 4.0, x = 1197.48, y = -1282.29, z = 76.45, time = 120000, name = "Rhodes Station" }, --2 min stop
	{ dst = 220.0, dst2 = 4.0, x = -379.38, y = -369.51, z = 86.44, time = 60000, name = "Flatneck Station" }, --1 min stop
	{ dst = 180.0, dst2 = 4.0, x = -1118.27, y = -567.17, z = 82.67, time = 60000, name = "Riggs Station" }, --1 min stop
	{ dst = 180.0, dst2 = 4.0, x = -1291.04, y = 440.69, z = 94.36, time = 120000, name = "Wallace Station" }, --2 min stop
	{ dst = 180.0, dst2 = 4.0, x = 610.54, y = 1661.53, z = 188.0, time = 30000, name = "Bacchus Station" }, --30 sec stop
	{ dst = 220.0, dst2 = 4.0, x = 2914.50, y = 1238.53, z = 44.73, time = 120000, name = "Annesburg Station" }, --2 min stop
...
Config.Elements = {
	-- { label = "sleeper car train", value = 'hash1', desc = "spawn a long train ", info = Config.trainmodel1 },
	{ label = "passenger train", value = 'hash2', desc = "spawn a train ", info = Config.trainmodel2 },
	{ label = "private train", value = 'hash3', desc = "spawn a train ", info = Config.trainmodel3 },
	...
	{ label = "fancy passenger train", value = 'hash9', desc = "spawn a train ", info = Config.trainmodel9 },
	...
	{ label = "cargo train", value = 'hash12', desc = "spawn a train ", info = Config.trainmodel12 },
