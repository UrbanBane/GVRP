...
Config.BathingZones = {
	...
	["Valentine"] = {
		...
		lady = `CS_ValProstitute_02`,
		guy = `U_M_M_NBXLiveryWorker_01`,
		door = 142240370
	},
	["Annesburg"] = {
		...
		lady = `MP_ASN_BENEDICTPOINT_FEMALES_01`,
		guy = `U_M_M_DorHomesteadHusband_01`,
		door = -201071322
	},
	["Strawberry"] = {
		...
		lady = `CS_ValProstitute_01`,
		guy = `A_M_M_FAMILYTRAVELERS_WARM_01`,
		door = 1256786197
	},
	["Blackwater"] = {
	...
	["Vanhorn"] = {
		...
		lady = `G_F_M_UNIDUSTER_01`,
		guy = `A_M_M_MOONSHINERS_01`,
		door = 1102743282
	},
	["Rhodes"] = {
	...
	--[["Tumbleweed"] = {
		...
		lady = `RE_SLUMAMBUSH_FEMALES_01`,
		guy = `RE_DRUNKCAMP_MALES_01`,
		door = 1682160693
	} ]]
}
...
Config.Prompts = {
	...
	{ label = "Wash", id = "SCRUB", control = `INPUT_CONTEXT_X`, time = 1000 },
