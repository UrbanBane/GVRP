...
AddEventHandler("parks_stagecoach:CreateNPC", function (zone)
    ...
    if not DoesEntityExist(npc) then
        ...
        npc = CreatePed( model, zone.x, zone.y, zone.z - 1, zone.h,  false, true) --creates NPC ped. Minus one on Z needed if entity is frozen to prevent floating
        Citizen.InvokeNative(0x283978A15512B2FE , npc, true )
        SetEntityAsMissionEntity(npc, true, true) -- sets ped as mission entity to prevent despawning
        SetEntityInvincible(npc, true) -- sets ped invincible
        FreezeEntityPosition(npc, true) -- freezes ped
        SetBlockingOfNonTemporaryEvents(npc, true) -- ped cannot be intimidated
    end
end)
...
local Coaches = {
    ...
    },
    {
        ...
        ['Desc'] = "",
        ['Param'] = {
            ['Name'] = "Large Open Passenger Wagon",
            ['Price'] = 450,
            ['Model'] = "WAGON03X"
        }
    },
    ...
    {
        ['Text'] = "Davis Overland Medium Coach - $600.",
        ['SubText'] = "",
        ['Desc'] = "",
        ['Param'] = {
            ['Name'] = "Davis Overland Medium Coach",
            ['Price'] = 600,
    ...
    },
     {
        ...
        ['Desc'] = "",
        ['Param'] = {
            ['Name'] = "Davis Overland Large Coach",
            ['Price'] = 600,
            ['Model'] = "COACH2"
        }
    },
    ...
    },
    {
        ...
        ['Desc'] = "",
        ['Param'] = {
            ['Name'] = "Solid Roof Davis Medium Coach",
            ['Price'] = 625,
    ...
    },
    {
        ...
        ['Param'] = {
            ['Name'] = "Large Armoured Boles Coach",
            ['Price'] = 1000,
...
Citizen.CreateThread(function()
    ...
    Wait(10)
        for _, zone in pairs(Config.Marker) do
            if GetDistanceBetweenCoords(zone.x, zone.y, zone.z,GetEntityCoords(PlayerPedId()),false)<1.5 then
