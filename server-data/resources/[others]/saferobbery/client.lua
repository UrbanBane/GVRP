...
AddEventHandler('gorp:saferobbery', function()
	TriggerServerEvent("gorp:SafeRobberyAlarm")
end)

RegisterNetEvent('gorp:saferobberyCracking')
AddEventHandler('gorp:saferobberyCracking', function()
	...
	math.randomseed(math.random(0,1121620))
	local waitTime = math.random(0,3600)
	Wait(waitTime)
	blip = {
		blipsprite = 2119977580,
		Name = 'Safe Robbery',
	}
	TriggerServerEvent("syn_alert:sendalert",GetPlayers(),Marshal_Jobs,"Someone is trying to open a safe",blip,false)
end)