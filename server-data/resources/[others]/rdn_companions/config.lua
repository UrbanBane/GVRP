...
Config.AnimalFood = 'kibble' -- The item required to feed and/or level up your pet


Config.Shops = {
    {
        Name = 'H&H Hunting Dogs',
        Ring = false,
        ActiveDistance = 5.0,
        Coords = {
...
Config.PetAttributes = {
    ...
    DeathCooldown = 30 -- Time before a pet can be respawned after dying
}
