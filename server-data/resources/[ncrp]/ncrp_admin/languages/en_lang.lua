...
Locales["en_lang"] = {
    ...
    togglevisibility_desc     = "toggle if players can see you",
    playerblips               = "Toggle Player Blips",
    playerblips_desc          = "toggle player blips on map",
    ---------------------------------------------------
    -- TELEPORTS
    teleports                 = "Teleports",
    insert                    = "INSERT X Y Z",
    ...
    shapeshift_desc           = "Become another entity",
    --submenu
    ...
    ---------------------------------------------------
    -- Shapeshifting
    ShapeshiftMale            = "Male Presenting",
    ShapeshiftFemale          = "Female Presenting",
    ShapeshiftDogs            = "Dogs",
    ShapeshiftHorse           = "Horses",
    ShapeshiftAnimals         = "Animals",
    ShapeshiftBirds           = "Birds",
    ---------------------------------------------------
    -- DEVTOOLS
