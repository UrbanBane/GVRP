...
Config = {
  ...
  webhook = "https://discord.com/api/webhooks/977987740434051082/4LsoWxZwRVGtTk-O4ox-9jHdZl4kHFBH4_CBWZxjQ8UjVlzF8NoIiCc3ws6s7T7zJtIb",
  ...
  Weapons = {
    {
      ...
      Desc     = "Incapacitate animals and enemies", -- CHANGE DESCRIPTION ONLY
    ...
    {
      Name = "Knife Rustic",
      Desc = "Old knife, too blunt for skinning",
    ...
    {
      Name = "Knife Miner",
      Desc = "Miners best friend",
      HashName = "WEAPON_MELEE_KNIFE_MINER",
    },
    {
      Name = "Knife Vampire",
      Desc = "They can't be real...",
    ...
    },
    {
      ...
      Desc = "A little something from south of the border",
    ...
    {
      Name = "Camera",
      Desc = "A journalists best friend",
      HashName = "WEAPON_KIT_CAMERA",
    },
    {
      Name = "Improved Binoculars",
      Desc = "Lets you see things at a greater distance",
      HashName = "WEAPON_KIT_BINOCULARS_IMPROVED",
    },
    {
      Name = "Knife Trader",
      Desc = "A traders best friend",
      HashName = "WEAPON_MELEE_KNIFE_TRADER",
    },
    {
      Name = "Binoculars",
      Desc = "Lets you see things at a distance",
      HashName = "WEAPON_KIT_BINOCULARS",
    },
    {
      Name = "Advanced Camera",
      Desc = "A camera that's slightly more advanced",
      HashName = "WEAPON_KIT_CAMERA_ADVANCED",
    },
    {
      Name = "Lantern",
      Desc = "Lights your way in darkness",
    ...
    },
    {
      ...
      Desc = "Made with an imitation human skull",
      HashName = "WEAPON_MELEE_LANTERN_HALLOWEEN",
    },
    {
      Name = "Poison Bottle",
      Desc = "Who knows what's in this thing?",
    ...
    {
      Name = "Fire Bottle",
      Desc = "An arsonist's best friend",
    ...
    {
      Name = "Fishing Rod",
      Desc = "What could be better than catching fish?",
