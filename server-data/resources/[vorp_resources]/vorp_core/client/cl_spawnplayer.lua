...
function inCharacterCreation()
    charGen = vector3(-563.13, -3775.81, 238.6)
    distanceFromCharGen = GetPlayerDistanceFromCoords(charGen, PlayerPedId())
    return distanceFromCharGen < 100 and distanceFromCharGen > -100 
end 
...
CreateThread(function()
    while true do
        ...
        if innerHealth and innerStamina and getHealth and outerCoreStamina and not inCharacterCreation() then
