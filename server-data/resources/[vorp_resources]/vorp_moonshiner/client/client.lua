...
Citizen.CreateThread(function()
	...
	while true do
        ...
        local isNearStill = DoesObjectOfTypeExistAtCoords(x, y, z, 0.75, GetHashKey(Config.brewPop), true)
        local isNearBarrel = DoesObjectOfTypeExistAtCoords(x, y, z, 0.75, GetHashKey(Config.mashProp), true)
...
Citizen.CreateThread(function()
    ...
    while true do
        if WarMenu.IsMenuOpened('barrel') then
            ...
            if WarMenu.Button('Dismantle Barrel') then
