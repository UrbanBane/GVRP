...
Config.mashes = {
    ['tropicalPunchMash'] = { -- ['DB_ItemName'] here you define the mash
        Label = "Tropical Peach Mash", -- the displayed label of the mash
        items = { -- here you can define the reqired items for the mash
            ['consumable_peach'] = 2, -- ['DB_ItemName'] = HowMuchItemsYouNeed
            ['consumable_herb_wintergreen_berry'] = 2, 
            ['water'] = 1
        },
        mashTime = 0.3, -- time to mash in minutes
        minXP = 2, -- min xp you can get for producing
        maxXP = 5, -- max xp you can get for producing
        errorMSG = "You need: 2 Peaches, 2 Wintergreen Berry, 1 Water" -- error info if you dont have enough items for the mash
    },
    ['wildCiderMash'] = {
        Label = "Pear & Berry Mash",
        items = {
            ['consumable_pear'] = 2, 
            ['blueberry'] = 2, 
            ['water'] = 1
        ...
        minXP = 2,
        maxXP = 5,
        errorMSG = "You need: 2 Pears, 2 Blueberries, 1 Water"
    },
    ['appleBerryMash'] = {
        Label = "Apple & Huckleberry Mash",
        items = {
            ['apple'] = 2, 
        ...
        minXP = 2,
        maxXP = 5,
        errorMSG = "You need: 2 Apples, 2 Evergreen Huckleberries, 1 Water"
    },    
    ['alcohol'] = {
        Label = "Alcohol Base",
        items = {
        ...
        minXP = 2,
        maxXP = 5,
        errorMSG = "You need: 4 Potatoes, 1 Water"
    }
}
...
Config.moonshine = {
    ['tropicalPunchMoonshine'] = { -- ['DB_ItemName'] here you define the mash
        Label = "Tropical Peach Moonshine", -- the displayed label of the mash
        items = { -- here you can define the reqired items for the mash
            ['tropicalPunchMash'] = 1, -- ['DB_ItemName'] = HowMuchItemsYouNeed
            ['alcohol'] = 1, 
            ['water'] = 1,
        },
        ...
        minXP = 2, -- min xp you can get for producing
        maxXP = 5, -- max xp you can get for producing
        errorMSG = "You need: 1 Tropical Punch Mash, 1 Alcohol, 1 Water" -- error info if you dont have enough items for the mash
    },
    ['wildCiderMoonshine'] = {
        Label = "Pear & Blueberry Moonshine",
        items = {
            ['wildCiderMash'] = 1, 
            ['alcohol'] = 1, 
            ['water'] = 1,
        ...
        minXP = 2,
        maxXP = 5,
        errorMSG = "You need: 1 Pear & Berry Mash, 1 Alcohol, 1 Water"
    },
    ['appleBerryMoonshine'] = {
        Label = "Apple & Huckleberry Moonshine",
        items = {
            ['appleBerryMash'] = 1, 
            ['alcohol'] = 1, 
            ['water'] = 1,
        ...
        minXP = 2,
        maxXP = 5,
        errorMSG = "You need: 1 Apple & Huckleberry Mash, 1 Alcohol, 1 Water"
    }
}
