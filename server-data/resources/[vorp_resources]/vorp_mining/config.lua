...
---------------------------
Config.Items = {
    {name = "rock", label = "Rocks", chance = 100, amount = 1},
    {name = "salt", label = "Salt", chance = 90, amount = 1},
    {name = "clay", label = "Clay", chance = 80, amount = 2},
    {name = "coal", label = "Coal", chance = 70, amount = 4},
    {name = "sulfur", label = "Sulfur", chance = 60, amount = 2},
    {name = "quartz", label = "Quartz", chance = 60, amount = 2},
    {name = "copper", label = "Copper Ore", chance = 50, amount = 2},
    {name = "iron", label = "Iron Ore", chance = 40, amount = 2},
    {name = "saltpeter", label = "Saltpeter", chance = 40, amount = 2},
    {name = "zinc", label = "Zinc", chance = 40, amount = 2},
    {name = "silver", label = "Silver Ore", chance = 10, amount = 1},
    {name = "goldnugget", label = "Gold Nugget", chance = 5, amount = 1},
    {name = "emerald", label = "Emerald", chance = 2, amount = 1},
    {name = "ruby", label = "Ruby", chance = 2, amount = 1},
    {name = "sapphire", label = "Sapphire", chance = 2, amount = 1},
    {name = "diamond", label = "Diamond", chance = 1, amount = 1},
}
