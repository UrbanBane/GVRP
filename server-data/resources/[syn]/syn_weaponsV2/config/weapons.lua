...
Config4.weapons = {  
    ["Melee"] = {
        ["Horror Knife"] = {	
            ...
            jobs = {"gunsmith","rguns","sdgunsmith","annesburgguns","twgunsmith","bountyhunter","pinkerton","cumberlandguild","omenbounty","beanbounty","regulators","bwgunsmith","annesburggunsmith","frontierarms","strwgunsmith","blacksmith","bwblacksmith","sdblacksmith","creetsmith","emeraldsmith","valleysmith","rhodesblacksmith","macfarlansmith","valblacksmith","valleysmith","bpblacksmith","armablacksmith","grimfellows"}, 
            materials = {
        ...
        ["Jawbone Knife"] = {	
            ...
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            jobonly = true,
            jobs = {"gunsmith","shaman","bountyhunter","pinkerton","cumberlandguild","omenbounty","beanbounty","regulators","wapitishaman","blackhawkshaman","blacksmokeshaman","valwahyashaman","grimfellows"},
            materials = {
                item1 = {name = "ironbar",label = "Iron Bar", amount = 2},
                item2 = {name = "wood",label = "wood", amount = 1},
                item3 = {name = "deerskin",label = "deerskin", amount = 2},
        ...
        ["Hunter Hatchet"] = {	
            ...
            jobonly = true,
            jobs = {"shaman","bountyhunter","pinkerton","cumberlandguild","omenbounty","beanbounty","regulators","wapitishaman","blackhawkshaman","blacksmokeshaman","valwahyashaman"},
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable  
            materials = {
    ...
    ["Rifles"] = {
        ["Elephant Rifle"] = {	
            ...
            jobonly = true,
            jobs = {"gunsmith","rguns","sdgunsmith","annesburgguns","twgunsmith","bountyhunter","pinkerton","cumberlandguild","omenbounty","beanbounty","regulators","bwgunsmith","annesburggunsmith","frontierarms","strwgunsmith","grimfellows"}, 
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable  
            materials = {
        ...
        ["Varmint Rifle"] = {	
            ...
            jobonly = true,
            jobs = {"gunsmith","rguns","sdgunsmith","annesburgguns","twgunsmith","bwgunsmith","annesburggunsmith","frontierarms","strwgunsmith"}, 
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable  
            materials = {
                item1 = {name = "riflebarrel",label = "Rifle Barrel", amount = 1},
    ...
    ["Revolvers"] = {
        ...
        ["Navy Revolver"] = {	
            ...
            jobonly = true,
            jobs = {"gunsmith","sdgunsmith","annesburgguns","twgunsmith","rguns","bountyhunter","pinkerton","cumberlandguild","omenbounty","beanbounty","regulators","bwgunsmith","annesburggunsmith","frontierarms","strwgunsmith","grimfellows"}, 
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            materials = {
                item1 = {name = "revolverbarrel",label = "Revolver Barrel", amount = 1},
                item2 = {name = "revolverhandle",label = "Revolver Handle", amount = 1},
    ...
    -- only then will the throwable show up in their weapon wheel 
        ["Bolas Hawkmoth"] = {	
            ...
            diff = 3000,
            jobonly = true,
            jobs = {"bountyhunter","pinkerton","cumberlandguild","omenbounty","beanbounty","regulators","grimfellows"},  
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            materials = {
                item1 = {name = "ironbar",label = "Iron Bar", amount = 2},
        ...
        ["Knives"] = {	
            ...
            jobonly = true,
            jobs = {"gunsmith","rguns","sdgunsmith","annesburgguns","twgunsmith","shaman","bountyhunter","pinkerton","cumberlandguild","omenbounty","beanbounty","regulators","bwgunsmith","annesburggunsmith","frontierarms","strwgunsmith","wapitishaman","blackhawkshaman","blacksmokeshaman","valwahyashaman","grimfellows"}, 
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            materials = {
                item1 = {name = "ironbar",label = "Iron Bar", amount = 3},
                item2 = {name = "wood",label = "wood", amount = 1},
    ...
    ["Shotguns"] = {
        ...
        ["Sawedoff Shotgun"] = {	
            ...
            jobonly = true,
            jobs = {"gunsmith","sdgunsmith","annesburgguns","twgunsmith","rguns","bwgunsmith","annesburggunsmith","frontierarms","strwgunsmith"}, 
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable  
            materials = {
                item1 = {name = "shotgunbarrel",label = "Shotgun Barrel", amount = 1},
                item2 = {name = "shotgunstock",label = "Shotgun Stock", amount = 1},
    ...
    ["Misc."] = {
        ["Metal Dectector"] = {	 
            ...
            jobonly = true,
            jobs = {"gunsmith","bountyhunter","pinkerton","sdgunsmith","annesburgguns","twgunsmith","rguns","cumberlandguild","omenbounty","beanbounty","regulators","bwgunsmith","annesburggunsmith","frontierarms","strwgunsmith","grimfellows"},  
        ...
        ["Fishing Rod"] = {	
            ...
            jobonly = true,
            jobs = {"gunsmith","bountyhunter","pinkerton","sdgunsmith","annesburgguns","twgunsmith","rguns","shaman","cumberlandguild","omenbounty","beanbounty","regulators","bwgunsmith","annesburggunsmith","frontierarms","strwgunsmith","wapitishaman","blackhawkshaman","blacksmokeshaman","valwahyashaman","grimfellows"},  
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            materials = {
