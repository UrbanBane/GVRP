...
RegisterServerEvent('syn_pinboard:getjob')
AddEventHandler('syn_pinboard:getjob', function(type)
    local _source = source
        ...
        logs = {
          {
              ...
              ["footer"] = {["text"]="Town: "..city,["icon_url"]= "https://media.discordapp.net/attachments/805495169901789194/911350679447150603/unknown.png"}
          }
        }
    else
        logs = {
